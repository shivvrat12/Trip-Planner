...
@Composable
fun LoginScreen(navController: NavController, viewModel: TripViewModel) {
    ...
    Column(
        ...
        Text(
            text = "Let's begin the journey together",
            fontFamily = afacadFlux,
            style = typography.titleLarge,
            color = colorScheme.onSurface
        )
        ...
        Button(
            ...
            if (isLoading.value) {
                ...
                Text(text = "Sign In", fontFamily = afacadFlux)
            }
        }
        Spacer(modifier = Modifier.height(16.dp))
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
            Text(
                text = "Don't have an account? ", style = typography.bodySmall,
                color = colorScheme.onSurface
            )
            Text(text = "Sign Up", style = typography.bodySmall, color = colorScheme.primary,
